from sqlalchemy import BigInteger, Column, Integer, String, Boolean, ForeignKey, DateTime, Text
...
class User(Base):
    ...
    active_channel_id = Column(Integer, ForeignKey('channels.id', ondelete='SET NULL'), nullable=True)
...
class Channel(Base):
    ...
    drafts = relationship("Draft", back_populates="channel", cascade="all, delete-orphan")
    published_posts = relationship("PublishedPost", back_populates="channel", cascade="all, delete-orphan")
...
class Draft(Base):
    ...
    scheduled_posts = relationship("ScheduledPost", back_populates="draft", cascade="all, delete-orphan")
